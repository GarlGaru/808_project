...
public class ReviewDTO {
    ...
    public ReviewDTO(int reviewId, int userNum, String showId, int rating, String content, Date createdAt,
			String nickname, String concertTitle, int userId) {
		super();
	...
	public String toString() {
		return "ReviewDTO [reviewId=" + reviewId + ", userNum=" + userNum + ", showId=" + showId + ", rating=" + rating
				+ ", content=" + content + ", createdAt=" + createdAt + ", nickname=" + nickname + ", concertTitle="
				+ concertTitle + ", userId=" + userId + "]";
	}
