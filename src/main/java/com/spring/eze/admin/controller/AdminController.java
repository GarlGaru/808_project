...
public class AdminController {
	...
	@GetMapping("/board")
    public String boardtables(HttpServletRequest request, HttpServletResponse response, Model model) 
            throws ServletException, IOException {
        
        System.out.println("AdminController - boardtables");
	...
	public String insertSong(AdminMusicDTO dto,
			@RequestParam(value = "songFile", required = false) MultipartFile songFile, HttpServletRequest request,
...
//    //어드민 아티스트 조회
	...
	public String insertArtist(AdminMusicDTO dto,
		...
		System.out.println(
				"artistImageFile = " + (artistImageFile == null ? "null" : artistImageFile.getOriginalFilename()));
	...
	public String insertAlbum(AdminMusicDTO dto,
		...
		System.out.println(
				"albumImageFile = " + (albumImageFile == null ? "null" : albumImageFile.getOriginalFilename()));
