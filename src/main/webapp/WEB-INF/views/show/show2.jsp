...
<body class="dark-mode">
    ...
    <div class="show-wrap">
     	<!-- 1) 장르 배너 시작 -->
     	<div class="genre-bar">
     		<a href="javascript:void(0);" onclick="filterCategory('concert','${path}')">콘서트</a>
     		<a href="javascript:void(0);" onclick="filterCategory('musical','${path}')">뮤지컬</a>
     		<a href="javascript:void(0);" onclick="filterCategory('play','${path}')">연극</a>
     		<a href="#">랭킹</a>
     		<a href="#">후기</a>
     	</div>
     	<!-- 1) 장르 배너 종료 -->
